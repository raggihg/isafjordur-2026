    ...
    <section className="panel eventsPanel">
      <div className="panelHeader">
        <div>
          ...
          <p>Viðburðir og kosningakaffi sem hafa verið auglýst eftir 13. apríl.</p>
        </div>
      </div>
      ...
      <div className="eventTimeline">
        {visibleEvents.map((event) => {
          ...
          return (
            <a className="eventItem" href={event.url} target="_blank" rel="noreferrer" key={`${event.date}-${event.title}`}>
...
function ArticlesPanel({ setActiveTopic }) {
  return (
    <section className="panel articlesPanel">
      <div className="panelHeader">
        <div>
      ...
      <div className="articleGrid">
        {articles.map((article) => (
          <button
            ...
            key={article.title}
            onClick={() => article.topicId && setActiveTopic(article.topicId)}
          >
